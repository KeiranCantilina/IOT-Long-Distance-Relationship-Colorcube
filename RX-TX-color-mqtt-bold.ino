...
volatile long x=0;
volatile long red_int;
volatile long green_int;
volatile long blue_int;
...
void loop() {
  ...
  int random_value = random(1,3);

  if (random_value == 1){
    long red_int = random(111,367);
    long temporary_value = 366 - red_int;
    long green_int = random(111,temporary_value);
    long blue_int = 366 - (red_int+green_int);
  }

  if (random_value == 2){
    long green_int = random(111,367);
    long temporary_value = 366 - green_int;
    long blue_int = random(111,temporary_value);
    long red_int = 366 - (blue_int+green_int);
  }

  if (random_value == 3){
    long blue_int = random(111,367);
    long temporary_value = 366 - blue_int;
    long red_int = random(111,temporary_value);
    long green_int = 366 - (red_int+blue_int);
  }
